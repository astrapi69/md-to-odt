...
version: [![Maven Central](https://img.shields.io/maven-central/v/io.github.astrapi69/md-to-odt?style=plastic)](https://search.maven.org/artifact/io.github.astrapi69/md-to-odt)

You can first define the version in the ext section and add than the following gradle dependency to
your project `build.gradle` if you want to import the core functionality of md-to-odt:

define version in file gradle.properties

```
mdToOdtVersion=${latestVersion}
```
...
```
    implementation("io.github.astrapi69:md-to-odt:$mdToOdtVersion")
```
...
```
```
md-to-odt-version= "${latestVersion}"
```
```
[libraries]
```
```
md-to-odt = { module = "io.github.astrapi69:md-to-odt", version.ref = "md-to-odt-version" }
```

then add the dependency to the dependencies area

```
    implementation libs.md.to.odt
```
...
Check
out [sonatype repository](https://oss.sonatype.org/index.html#nexus-search;gav~io.github.astrapi69~md-to-odt~~~)
for latest snapshots and releases.

Add the following maven dependency to your project `pom.xml` if you want to import the core
functionality of md-to-odt:
...
```xml
        <!-- md-to-odt version -->
        <md-to-odt.version>${latestVersion}</md-to-odt.version>
```
...
```xml
            <!-- md-to-odt DEPENDENCY -->
            <dependency>
                <groupId>io.github.astrapi69</groupId>
                <artifactId>md-to-odt</artifactId>
                <version>${md-to-odt.version}</version>
            </dependency>
```
...
[![Snapshot](https://img.shields.io/badge/dynamic/xml?url=https://oss.sonatype.org/service/local/repositories/snapshots/content/io/github/astrapi69/md-to-odt/maven-metadata.xml&label=snapshot&color=red&query=.//versioning/latest)](https://oss.sonatype.org/content/repositories/snapshots/io/github/astrapi69/md-to-odt/)
